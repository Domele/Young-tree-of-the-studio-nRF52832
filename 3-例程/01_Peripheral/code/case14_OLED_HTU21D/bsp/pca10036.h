...
#define CTS_PIN_NUMBER 7//5
#define RTS_PIN_NUMBER 5//7
...
#define SPIM1_SS_PIN    9  //5 // SPI Slave Select GPIO pin number.
...
#define SER_APP_SPIM0_SCK_PIN       29//27     // SPI clock GPIO pin number.
#define SER_APP_SPIM0_MOSI_PIN      25//2      // SPI Master Out Slave In GPIO pin number
#define SER_APP_SPIM0_MISO_PIN      28//26     // SPI Master In Slave Out GPIO pin number
#define SER_APP_SPIM0_SS_PIN        12//23     // SPI Slave Select GPIO pin number
#define SER_APP_SPIM0_RDY_PIN       25     // SPI READY GPIO pin number
#define SER_APP_SPIM0_REQ_PIN       24     // SPI REQUEST GPIO pin number

// serialization CONNECTIVITY board
#define SER_CON_RX_PIN              6//24    // UART RX pin number.
#define SER_CON_TX_PIN              8//23    // UART TX pin number.
#define SER_CON_CTS_PIN             5//25    // UART Clear To Send pin number. Not used if HWFC is set to false.
#define SER_CON_RTS_PIN             7//2     // UART Request To Send pin number. Not used if HWFC is set to false.


#define SER_CON_SPIS_SCK_PIN        29//27    // SPI SCK signal.
#define SER_CON_SPIS_MOSI_PIN       25//2     // SPI MOSI signal.
#define SER_CON_SPIS_MISO_PIN       28//26    // SPI MISO signal.
#define SER_CON_SPIS_CSN_PIN        12//23    // SPI CSN signal.
