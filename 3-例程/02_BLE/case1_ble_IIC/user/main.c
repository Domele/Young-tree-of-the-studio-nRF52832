...
#define DEVICE_NAME                     "Nordic_HTU21"                               /**< Name of device. Will be included in the advertising data. */
...
//    char strbuf[20];
//	//char strbuf2[20];
//const uint8_t TEXT_Buffer_SPI[]={"TEST_1234"};
...
//		delay_ms(1000);
//	}
	//printf("send:'1', to read htu21d data!\r\n");
