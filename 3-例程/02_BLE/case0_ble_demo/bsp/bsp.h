...
#define BSP_INIT_LED     17//(1 << 0) /**< This bit enables LEDs during initialization (@ref bsp_init).*/
#define BSP_INIT_BUTTONS 13//(1 << 1) /**< This bit enables buttons during initialization (@ref bsp_init).*/
